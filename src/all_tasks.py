...
res=t01_01_mark_time.main(inputPath)
print("=====================task 01-02=====================", file=sys.stderr)
res=t01_02_mark_rentaishi.main(inputPath)
print("=====================task 01-03=====================", file=sys.stderr)
res=t01_03_mark_person.main(inputPath)
print("=====================task 01-04=====================", file=sys.stderr)
res=t01_04_time_group.main(inputPath)

print("=====================task 02-01=====================", file=sys.stderr)
res=t02_01_extract_time.main(inputPath)
print("=====================task 02-02=====================", file=sys.stderr)
res=t02_02_extract_people.main(inputPath)
print("=====================task 02-03=====================", file=sys.stderr)
res=t02_03_mark_kakari.main(inputPath)
print("=====================task 02-04=====================", file=sys.stderr)
res=t02_04_mark_verb.main(inputPath)
print("=====================task 02-05=====================", file=sys.stderr)
res=t02_05_extract_act.main(inputPath)
